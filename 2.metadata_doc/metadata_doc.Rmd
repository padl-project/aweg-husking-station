...
email <- c("alex.wegmann@tnc.org", "")
orcid <- c("https://orcid.org/0000-0002-0595-7552", "")
...
p_first_name <- c("Alex", "Camila")
p_middle_in <- c("Wegmann", "", "")
...
Description <- c("2004-05-28", "2005-09-26", "Completed")
...
cat_vars <- read.delim2(here::here("data_attributes/catvars_FILE NAME.txt"))
